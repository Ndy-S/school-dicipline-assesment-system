<template>
    <nav
        ...
        class="fixed left-0 top-0 z-[1035] h-screen w-60 -translate-x-full overflow-hidden bg-white bg-opacity-70 shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] dark:bg-zinc-800 md:data-[te-sidenav-hidden='false']:translate-x-0"
        ...
        <div class="absolute bottom-0 h-24 w-full bg-white bg-opacity-10 text-center">
