    ...
    <Layout :can="can">
        <div class="mx-auto w-11/12 mt-4 min-h-[87.5%] p-4 px-8 bg-neon-custom-color rounded-lg shadow-2xl font-mono">
            <div class="flex items-center justify-between mb-5">
                ...
                <ButtonSearch :dataPaginate="siswaPaginate" :params="params" :openCreateModal="openCreateModal" :canCreate="can.createSiswa" />
            </div>
...
<script setup>
    ...
    const commonColumns = ['nama', 'nis', 'kelas', 'gender', 'agama', 'alamat', 'handphone', 'orang tua', 'tanggal dibuat'];

    const tableProps = {
        tableHead: props.can.createSiswa ? ['aksi', ...commonColumns] : commonColumns,
    };
